...
public class Student {
    ...
    public void addCourse(Course course) {
        //* Desde el estudiante, agrego un curso, y en el curso mismo, obtengo el estudiante y le agrego el curso */
        this.courses.add(course);
        course.getStudents().add(this);
    }
    
    public void removeCourse(Course course) {
        //* Desde el estudiante, elimino un curso, y en el curso mismo, obtengo el estudiante y le elimino el curso */
